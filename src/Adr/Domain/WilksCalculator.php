...
use WTCalcs\Adr\Domain\WilksResult;
...
class WilksCalculator extends AbstractModel implements ModelInterface
{
    ...
    public function wilksAge(float $weight, float $bodyWeight, string $gender, int $age): WilksResult
    {
        ...
        return new WilksResult('Wilks (AGE)', ($wilksAge * $ageFactor), ['mult' => $ageFactor]);
    }
}
